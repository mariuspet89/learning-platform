...
import eu.accesa.learningplatform.authentication.FileInputResource;
...
public class PemUtils {
    ...
    public static PublicKey getPublicKeyFromPEM(String key) {
        ...
        try {
            ...
            throw new ServiceException("Error trying to load public key from PEM format");
        }
    }
  ...
  public static PrivateKey getPrivateKeyFromPEM(String key) {
        ...
        try {
            ...
            throw new ServiceException("Error trying to load private key from PEM format");
        }
    }
